...
struct fractal {
	...
	int **values;
	double average;
}; // partout ou on utilisera Fractal, on fera reference a sa structure
...
/*
* fractal_get_average: retourne la valeur moyenne de la fractale
*
* @f: fractale
* @return: moyenne
*/
...
/*
* fractal_calculate_average
*
* Calcule la valeur moyenne d'une fractale sur tous ses pixels et affecte les valeurs du tableau
*
* @f: fractale sur laquelle on effectue le calcul
* @return: la valeur moyenne de la fractale
*/
double fractal_compute_averageandtable(struct fractal *f);
